...
from simulation import StimulusEngine, sample_preview_state  # noqa: E402
...
class StimulusEngineTests(unittest.TestCase):
    ...
    def test_post_split_clusters_remain_tight_near_their_attractors(self) -> None:
        ...
        self.assertLess(max(left_distances), config.target_cluster_radius * 0.35)
        self.assertLess(max(right_distances), config.target_cluster_radius * 0.35)
