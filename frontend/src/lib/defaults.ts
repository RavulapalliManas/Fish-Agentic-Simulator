...
export const PARAMETER_SPECS: ParameterSpec[] = [
  ...
  },
  {
    ...
    label: "Aggregation Ends At",
    tooltip: "Sets the exact time when aggregation finishes and stabilization begins.",
    min: 5,
    max: 90,
    step: 1,
    recommended: [12, 36],
    warning: "This aggregation end time may feel too rushed or unnecessarily prolonged.",
    unit: "seconds",
    precision: 0,
  },
  {
    key: "time_to_split",
    group: "splitting-control",
    label: "Split Starts At",
    tooltip: "Sets the exact time when the deterministic split begins. Later values leave more time for stabilization before the branches diverge.",
    min: 15,
    max: 170,
    step: 1,
    recommended: [40, 120],
  ...
  },
  {
    ...
    group: "rendering",
    label: "Video Ends At",
    tooltip: "Sets the final MP4 duration. This app is tuned for 1-3 minute experimental stimuli.",
    min: 60,
    max: 180,
    step: 1,
    recommended: [60, 180],
    warning: "This duration is outside the recommended 1-3 minute range for this experiment workflow.",
    unit: "seconds",
    precision: 0,
  },
  {
